...
<head>
    ...
    <meta property="og:description"
        content="Lalla, shop thời trang." />
    <meta property="og:image" content="/images/fb_thumb.png" />
    <meta property="og:url" content="https://shopquanthang.000webhostapp.com/" />
...
<body>
    ...
    <section class="wrapperCard">
        <h3 class="section__title">QTshop</h3>
        <div class="cards">
            <!--card-->
            <!-- php get product -->
            <?php 
